...
def run(
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # det = pred
            det = torch.from_numpy(newRed).to(device)
...
if __name__ == "__main__":
    opt = parse_opt()
    opt.weight = r'G:\qxz\MyProject\301Bacteria\yolov5-master\runs\train\exp10\weights\best.pt'
    # opt.source = r''
    opt.data = r'G:\qxz\MyProject\301Bacteria\yolov5-master\data/MyYamlI6Data.yaml'
    opt.imgsz = 640
    opt.conf_thres = 0.25
    opt.iou_thres = 0.45
    opt.device = '0'
