...
class DetectMultiBackend(nn.Module):
    ...
    def forward(self, im, augment=False, visualize=False, getFeature=False):
        ...
        if self.pt:  # PyTorch
            y = self.model(im, augment=augment, visualize=visualize, getFeature=getFeature) if augment or visualize else self.model(im, getFeature=getFeature)
